$(document).ready(function () {
  ...
  function RefreshPage() {
    ...
    window.location.replace(
      BASE_URL +
        `users/agent_lists?DataNumber=${entries}&SearchQuery=${search}&page=${page}`
    );
  }

  $("#agents_table tbody").on("click", ".edit-agent", function (e) {
    e.preventDefault();
    ...
    $.ajax({
      ...
      success: function (response) {
        if (!response.isError) {
          $("#agentID").val(response.Message.id);
  ...
  $("#agents_table tbody").on("click", ".profile-agent", function (e) {
    e.preventDefault();
  ...
  $("#agents_table tbody").on("click", ".password-agent", function (e) {
    e.preventDefault();
